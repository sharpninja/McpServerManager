...
internal sealed class DirectorAuthorizationPolicyService : IAuthorizationPolicyService
{
    ...
    private static readonly IReadOnlyDictionary<McpArea, string> s_areaRoles = new Dictionary<McpArea, string>
    {
        ...
        [McpArea.Triage] = McpRoles.Viewer,
        [McpArea.Todo] = McpRoles.Viewer,
        [McpArea.Memory] = McpRoles.Viewer,
    ...
    private static readonly IReadOnlyDictionary<string, string> s_actionRoles =
        new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase)
        {
            ...
            [McpActionKeys.TodoMove] = McpRoles.Viewer,
            ...
            [McpActionKeys.MemoryList] = McpRoles.Viewer,
            [McpActionKeys.MemoryGet] = McpRoles.Viewer,
            [McpActionKeys.MemoryAdd] = McpRoles.Viewer,
            [McpActionKeys.MemoryUpdate] = McpRoles.Viewer,
            [McpActionKeys.MemoryRemove] = McpRoles.Viewer,
