...
/// </summary>
[ViewModelCommand("requirements-tr-detail", Description = "Get/create/update/delete/assign technical requirements")]
public sealed class TrDetailViewModel : AreaDetailViewModelBase<TechnicalRequirementItem>
{
    ...
    /// <summary>
    /// Assigns a technical requirement to a (potentially different) workspace.
    /// Used by the Director TUI "Assign WS" button (following FrDetailViewModel pattern).
    /// </summary>
    public async Task<RequirementsMutationOutcome?> AssignToWorkspaceAsync(string id, string workspacePath, CancellationToken ct = default)
    {
        ...
        try
        {
            var result = await _dispatcher.SendAsync(
                new AssignTechnicalRequirementToWorkspaceCommand(id, workspacePath), 
