...
/// <summary>Command to move a TODO item to another registered workspace.</summary>
public sealed record MoveTodoCommand(string TodoId, string TargetWorkspacePath) : ICommand<TodoMutationOutcome>;
