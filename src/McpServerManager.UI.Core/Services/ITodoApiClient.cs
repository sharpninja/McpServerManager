...
public interface ITodoApiClient
{
    ...
    /// <summary>
    /// Moves a TODO item to another registered workspace.
    /// </summary>
    Task<TodoMutationOutcome> MoveTodoAsync(MoveTodoCommand command, CancellationToken cancellationToken = default)
        => Task.FromResult(new TodoMutationOutcome(false, "TODO move is not supported by this host.", null, TodoMutationFailureKind.Validation));
