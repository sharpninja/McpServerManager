...
public sealed record ShowRequestDetailsCommand(McpServerManager.UI.Core.Models.Json.SearchableTurn Entry) : ICommand<bool>;
...
public sealed record SelectSearchTurnCommand(McpServerManager.UI.Core.Models.Json.SearchableTurn Entry) : ICommand<bool>;
...
public sealed record CopyOriginalJsonCommand(McpServerManager.UI.Core.Models.Json.UnifiedSessionTurn? Entry) : ICommand<bool>;
...
public sealed record ArchiveTreeItemCommand(McpServerManager.UI.Core.Models.FileNode? Node) : ICommand<bool>;
...
public sealed record OpenTreeItemCommand(McpServerManager.UI.Core.Models.FileNode? Node) : ICommand<bool>;
...
public sealed record TreeItemTappedCommand(McpServerManager.UI.Core.Models.FileNode? Node) : ICommand<bool>;
...
public sealed record JsonNodeDoubleTappedCommand(McpServerManager.UI.Core.Models.Json.JsonTreeNode? Node) : ICommand<bool>;
...
public sealed record SearchRowTappedCommand(McpServerManager.UI.Core.Models.Json.SearchableTurn? Entry) : ICommand<bool>;
